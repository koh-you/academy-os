...
unit: CM1-CB
type: CB-T01
type_in_source: 여러 가지 개수에 대한 문제
status: meta_only
external_labels:
...
**유형명 (자체)**: 여러 가지 개수에 대한 문제

**원 출처**: 260614_수능&모의 공통(10).pdf / 페이지 25 / left 컬럼 / 문항번호 49
