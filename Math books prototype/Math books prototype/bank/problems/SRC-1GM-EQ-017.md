...
unit: CM1-EQ
type: SRC-1GM
type_in_source: 세 유리수 a,b,c, ax²+√2bx+c=0 한 근 1+√2, 다른 근 β → α+1/β
status: meta_only
external_labels:
...
**발문 요지**: 세 유리수 a,b,c, ax²+√2bx+c=0 한 근 1+√2, 다른 근 β → α+1/β

**원 출처**: 1등급마스터 22개정 공통수학 / 항목 327 / score: 2.25 / 통찰: EQV(3)·CON(2)·MI(2)·PD(2)
