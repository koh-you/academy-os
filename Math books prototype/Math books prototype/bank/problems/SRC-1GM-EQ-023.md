...
unit: CM1-EQ
type: SRC-1GM
type_in_source: x²+2ax-b=0 두 근 차 12 미만, 두 소수 a,b 순서쌍 개수
status: meta_only
external_labels:
...
**발문 요지**: x²+2ax-b=0 두 근 차 12 미만, 두 소수 a,b 순서쌍 개수

**원 출처**: 1등급마스터 22개정 공통수학 / 항목 333 / score: 2.25 / 통찰: EQV(3)·CON(2)·MI(2)·PD(2)
