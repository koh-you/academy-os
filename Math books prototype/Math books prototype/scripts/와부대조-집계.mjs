...
const P1 = 판정읽기('bank/measurements/와부대조-판정-P1.md');
const P2 = 판정읽기('bank/measurements/와부대조-판정-P2.md');

const 갈래 = new Map(), 원번호 = new Map();
for (const L of 읽기('bank/measurements/와부대조-봉인표-34문-v2.md').split(/\r?\n/)) {
