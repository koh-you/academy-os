% 0965(본책 136쪽) — 대응 f: X={1,2,3} → Y={4,5,6}, 1→4, 1→5, 2→6, 3→5. 스캔 그림이라 TikZ 로 다시 그림.
...
\begin{tikzpicture}[line width=0.5pt, every node/.style={font=\small}]
  ...
  \node[inner sep=1.5pt] (y0) at (1.90,0.55) {$4$};
  \node[inner sep=1.5pt] (y1) at (1.90,0.00) {$5$};
  \node[inner sep=1.5pt] (y2) at (1.90,-0.55) {$6$};
