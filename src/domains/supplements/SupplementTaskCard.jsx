...
export function SupplementTaskCard({ actionProps, cancellationSlot = null, headerProps, notificationProps, saveSummaryProps, scheduleEditorProps, scheduleGateProps, sourceContextProps }) {
  return (
