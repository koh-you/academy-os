...
// 2026-09-19 · U12(ops-08): 저장·알림톡 발송 준비·링크 복사 버튼과 결과 문구는 안내문 작업공간의 하단 저장 바와
// 탭 아래 AsyncOperationStatus(DashboardAuxiliaryPanels)로 옮겼다. 여기는 알림톡 본문 미리보기만 남는다.
export function SpecialLectureNoticeActionPanel({ noticeText = "" }) {
  return (
