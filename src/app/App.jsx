...
} from "../domains/lessons/examPrepLessonPresentation.js";
...
export function App() {
  ...
  const calendarLessons = useMemo(
    () => mergeGeneratedCalendarLessons({
      ...
      lessons: filterStaleGeneratedExamPrepLessons({ lessons, planItems: generatedLessonPlan })
    }),
    [autoGeneratedDisplayLessons, generatedLessonPlan, lessons]
  );
  ...
  const teacherViewAdapters = createTeacherViewAdapters({
    ...
    models: {
      ...
      examPrepScheduleLessons: calendarLessons.filter((lesson) => lesson.lessonType === "examPrep"),
      homeworks,
      integrationStatus,
      isLessonJournalOpen,
