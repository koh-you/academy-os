...
export function App() {
  ...
  useEffect(() => {
    ...
    setExamPrepRows((current) => {
      const nextRowsToAdd = buildExamPrepRowsFromStudents(students, currentExamCycle, examPrepAutoRowClassTemplateId, current);
  ...
  }, [classTemplates.length, examPrepAutoRowClassTemplateId, setExamPrepRows, students]);
