...
export function createIntegrationStatusRouteRegistry({ getAiStatus, getNotificationStatus, sendJson }) {
  async function dispatch({ request, response, requestUrl }) {
    if (request.method !== "GET" || requestUrl.pathname !== "/api/integrations/status") return false;
