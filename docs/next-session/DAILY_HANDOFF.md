...
- 검수 에이전트 4축 결과·반영 내역: `latex-bank/ssen-basic-cm2/검수/2026-09-15/00-검수-요약.md`(바탕화면 `…-라텍스\검수-2026-09-15` 에도). 사람이 볼 것: ① ★ 라벨을 올린 5문(11-10·20-02·19-18·21-09·19-15 → ★3)과 통찰 라벨 바꾼 9문이 본인 기준에 맞는지(정독 md 각 블록 `[검수 2026-09-15]` 줄) ② 21-10 크롭 그림 화질 ③ 남은 것: 22문 정도 대상층(target_cohort) 재검토는 안 함.
