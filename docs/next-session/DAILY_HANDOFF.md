...
- 검증: supplement `10/10`, nested lesson boundary, lint, `check:fast`, production `823/823`, build `395 modules`·main `945.00 kB`·lazy `12/12`, safe browser `34/34`. 운영 데이터·실제 알림·SQL·유료 호출은 사용하지 않았다.
