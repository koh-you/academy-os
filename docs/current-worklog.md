...
- 검증: 시험정보 전용 fixture, runtime lint, build `410 modules`·lazy `12/12`, 로컬 안전 브라우저에서 전체 반 선택·탭 전환을 통과했다. production 묶음은 이번 경로와 무관한 기존 로그인·알림·보충 정적 시나리오 23건에서 실패했다.
