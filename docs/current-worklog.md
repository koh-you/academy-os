...
- 전수조사 결과: 공개 목록 API와 PostView로 30페이지, 게시물 893건, 2020-08-10~2026-07-20 범위를 확인했다. 중복 `logNo`는 0건이다. 시험분석 관련 글 49건·이미지 272장을 `1차 코퍼스 21건·203장`, `파생 종합글 3건·19장`, `과거 형식 보류 25건·50장`으로 분류했다.
...
- 재사용 범위: 기존 유료 Vision 결과 12건·116장은 재호출하지 않는다. 1차 코퍼스에서 새로 상세 분석할 범위는 용화여고와 2026년 1~6월 세트 등 9건·87장이다. 유료 호출 전 실제 신규 이미지·중복 해시와 호출 범위를 다시 보고한다.
...
- 다음 Gate: 기존 12건 raw 결과를 재사용하고 신규 9건·87장의 원본 URL/파일명/크기/해시/순서를 확정한다. 파생 종합글은 해시로 중복을 제거하며 과거 형식 25건은 대표 표본 승인 전 유료 분석하지 않는다.
