...
- 운영 데이터 저장과 실제 카카오톡·알림 발송은 연결하지 않았다. 검증: 전용 모델, student domain `15/15`, runtime lint, scenario `827/827`, build `414 modules`·main `942.25 kB`·lazy `12/12`, focused safe browser `1/1` 통과.
