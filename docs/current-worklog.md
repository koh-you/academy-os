...
- 요청/계약: 퇴원 처리는 학생 원천을 `paused`로 저장하되, 퇴원일과 그 이전의 수업·수업기록·출결·숙제는 보존한다. 수업 명단에서 제외하는 범위는 퇴원일 다음 날부터다. 예를 들어 2026-07-27에 조소현을 퇴원 처리하면 7월 27일 수업은 보존하고 7월 28일 이후 수업 명단에서만 제외한다.
