...
UI-0~UI-7, UI-8A·UI-8B·UI-8C·UI-8D·UI-8E·UI-8F·UI-8G를 완료했다. UI-7·8A·8B·8C·8D·8E·8F·8G 사람 시각 확인은 `docs/next-session/README.md`의 독립 절차로 누적되어 다음 화면군을 막지 않는다. 다음 UI-8H-0은 월별·특강 정산의 계산 원천·조정·제외·합계·저장 상태·모바일 예외를 inventory한다. 실제 정산 저장·금액/회차/제외 변경은 실행하지 않는다.
