...
UI-0~UI-7, UI-8A·UI-8B·UI-8C·UI-8D·UI-8E·UI-8F·UI-8G와 UI-8H-0~1을 완료했다. UI-7·8A·8B·8C·8D·8E·8F·8G 사람 시각 확인은 `docs/next-session/README.md`의 독립 절차로 누적되어 다음 화면군을 막지 않는다. 다음 UI-8H-2는 월별·특강 계산 원천, 조정·제외/복원·합계·검증 저장 callback과 공통 표·상태·save bar를 통합 회귀하고 독립 사람 시각 절차를 누적한다. 실제 정산 저장·금액/회차/제외 변경은 실행하지 않는다.
