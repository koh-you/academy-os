...
UI-0~UI-6과 UI-7A·UI-7B·UI-7C·UI-7D, UI-7E-1·2·3·4를 완료했다. 다음 UI-7E-5는 대표 action의 callback·disabled·submit·focus/touch 회귀계약을 한 번에 고정한다. 외부 side effect와 운영 원천은 바꾸지 않는다.
