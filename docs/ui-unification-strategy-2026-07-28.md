...
UI-0~UI-7, UI-8A·UI-8B·UI-8C·UI-8D·UI-8E를 완료했다. UI-7·8A·8B·8C·8D·8E 사람 시각 확인은 `docs/next-session/README.md`의 독립 절차로 누적되어 다음 화면군을 막지 않는다. 다음 UI-8F-0은 학생·Tally·반관리의 기본정보·원본·운영메모·반·퇴원 흐름과 모바일 예외를 읽기 전용 inventory로 정리한다. 실제 학생 저장·병합·퇴원·삭제는 실행하지 않는다.
