...
- 4-1 API payload 24개 contract와 4-2 DB/domain row mapper 45/45 분리·종료 감사는 완료했다. 4-3h까지 system/auth/portal route registry를 분리했고 다음 활성 단위는 교사 시험 후 제출 확인 뒤 app/core·domain·provider route 경계다.
