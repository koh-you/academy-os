...
- Phase 1 auth/session, Phase 2 출결 polling·동기화, Phase 3 notification/Solapi reconcile, Phase 4 hydration/persistence는 main 통합 완료다. 사용자 수업일지·보충관리 수정 통합 뒤 Phase 5 17개 teacher 화면 callback 조립을 재개한다.
