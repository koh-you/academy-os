...
- `ReportModal` footer 공통화는 완료해 공통 footer 10개·기존 action wrapper 7개가 됐다. 다음 단위는 bespoke Solapi 제어창의 shell만 공통화하되 callback identity·busy guard·safe-area layout을 유지한다.
