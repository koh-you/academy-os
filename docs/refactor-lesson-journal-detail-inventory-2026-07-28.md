...
43. 다음: 검증된 homework/makeup/record 응답의 state merge와 record save-state map을 순수 모델로 분리
44. `notification_jobs`/Solapi 예약·취소·발송결과 orchestration은 App callback에 남기고 순수 표시·판정만 분리
