...
73. 다음 `17K-3`: App 원천 조회·알림 제외 guard·builder 주입과 외부 action 경계를 closeout audit한다.
74. `notification_jobs` 조회·OS job 취소·provider 예약 반영·발송결과 reconcile orchestration은 App callback에 남기고 순수 표시·판정만 분리
