...
78. 다음 `17L-5`: 예약 상태 일괄 갱신 row의 입력·출력·시계·저장 side effect 경계를 inventory한다.
79. `notification_jobs` 조회·OS job 취소·provider 예약 반영·발송결과 reconcile orchestration은 App callback에 남기고 순수 표시·판정만 분리
