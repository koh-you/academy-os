...
3. **Phase 3 — 알림톡 reconcile·외부 부작용 경계**: refresh와 reconcile owner를 분리하고 scope별 in-flight, stale 응답, 중복 클릭, 실패 재시도를 고정한다. 조회·저장·예약·취소·발송은 별도 행동으로 유지한다. 2026-08-02 구현·전체 자동검증 완료.
