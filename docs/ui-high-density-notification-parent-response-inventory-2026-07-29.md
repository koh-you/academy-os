...
- UI-8D-3: 작성·대상·학부모 채널 찾기·기록의 responsive shell과 발송·예약·결과 대조·취소·삭제 callback 분리를 통합 회귀했다.
- desktop/390px 통합 사람 시각 절차를 handoff 최상단에 누적했으며 선택·검색·접기·복사 외 실제 side effect는 금지했다.
- UI-8D는 AI 검수 기준으로 완료했으며 실제 저장·발송·예약·삭제·출결은 실행하지 않았다.
