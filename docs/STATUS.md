...
3. App/API 4차는 4-0 기준선과 4-1a~4-1n의 source·notification reserve payload contract 연결을 확정했다. 다음은 notification cancel/provider payload를 실제 취소 없이 한 route씩 고정한다.
