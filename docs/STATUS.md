...
1. App 2차 Phase 1~5와 3차 3-0~3-8은 완료됐다. 운영 저장 신뢰성의 시험정보·Tally 후보·개별 학생·반 명단·수동/파생 학사일정 CAS/insert-only·재조회·부분실패 복구 단위도 완료했다. 다음은 수업일지 다중 행·복사·되돌리기 gate로 `lessons`·`lesson_student_records`·숙제 원천을 행동별로 분리해 검증한다.
