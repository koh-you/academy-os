...
3. App/API 4차는 4-0 기준선과 4-1a~4-1i의 lesson/supplement/attendance/class roster/derived calendar/app-state contract 연결을 확정했다. 다음은 report snapshot 전용 payload 계약이다.
