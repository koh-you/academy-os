...
- 교재관리 › 교재 상세에 「정답·해설 패키지 등록」, 오답지 인쇄에 빠른정답 격자·해설 쪽, 미리보기에 정답·해설이 붙었다. **사람 Gate**: `supabase/20260913_problem_bank_answers.sql` 적용 → 바탕화면 `문제은행-패키지\rpm-중3-2-수학-정답해설` 폴더 등록.
