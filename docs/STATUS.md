...
1. App 2차 Phase 1~5와 3차 3-0~3-8은 완료됐다. 운영 저장 신뢰성의 시험정보·Tally 후보·개별 학생·반 명단 CAS/insert-only·재조회·부분실패 복구 단위도 완료했으며, 다음은 학사일정 파생 저장과 수업일지 다중 행·복사·되돌리기의 다중 원천 저장 gate다.
