...
- 수업일지의 직전·다음 수업을 반 ID 하나로만 연결하지 않고 학생 프로필의 요일별 개별 시간표 전체를 따라 시간순으로 연결한다. 특정 학생·요일·시간대는 하드코딩하지 않았으며 특강 트랙 격리는 유지한다.
- 직전 보충 수업에 출결이 있지만 다음 숙제가 비어 있으면 더 오래된 정규수업 숙제로 건너뛰지 않는다. 이진후의 2026-08-31 수업에 2026-08-24 숙제가 연결된 운영 오데이터는 배포 후 CAS 삭제·재조회 대상으로 남겼다.
