...
3. App/API 4차는 4-0 기준선과 4-1a~4-1g의 lesson rows/history/makeup·supplement schedule·attendance check·class roster contract 연결을 확정했다. 다음은 registry의 derived school calendar payload를 client/server에 한 route로 연결한다.
