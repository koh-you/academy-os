...
3. App/API 4차는 4-0 기준선과 4-1a~4-1v의 source·notification·시험분석 run/문항 수·교사 검수 payload contract 연결을 확정했다. 다음은 prompt/output draft처럼 유료 실행 없는 시험분석 저장 route를 분리하고 Storage·유료 AI route는 4-5 대상으로 남긴다.
