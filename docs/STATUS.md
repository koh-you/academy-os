...
3. App/API 4차는 4-0 기준선과 4-1a~4-1s의 source·notification reserve/cancel/reconcile/bulk/readiness/dispatch payload contract 연결을 확정했다. 다음은 유료 실행 없는 exam analysis request/response inventory로 4-1 종료 범위를 확정한다.
