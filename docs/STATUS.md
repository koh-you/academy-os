...
1. App 2차 Phase 1~5와 3차 3-0~3-8, P1 운영 저장 신뢰성, P2 modal 통일 후속은 완료됐다. P3-0~P3-3b에서 알림 제품 경로 9개, 설정 key 10개, Solapi provider template 4개를 고정하고 출결·수업일지 client preview/server live body를 같은 pure renderer에 연결했다. 공지 preset 3개·특강 guide seed는 새 초안에만 적용하며 현재 draft·기존 job·보충 교사 최종본과 provider contract를 보존한다. 다음 P3-4는 9개 경로 종료 감사다.
