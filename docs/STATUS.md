...
3. App/API 4차는 4-0 기준선과 4-1a~4-1j의 lesson/supplement/attendance/class roster/derived calendar/app-state/report contract 연결을 확정했다. 다음은 resource material payload 계약이다.
