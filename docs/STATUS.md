...
1. App 2차 Phase 1~5와 3차 3-0~3-8은 완료됐다. 운영 저장 신뢰성의 시험정보·Tally 후보·개별 학생·반 명단·수동 학사일정 CAS/insert-only·재조회 단위도 완료했으며, 다음은 시험관리 행과 직전수업을 함께 바꾸는 학사일정 파생 저장 gate다. 수업일지 다중 행·복사·되돌리기는 그 뒤 별도 단위로 진행한다.
