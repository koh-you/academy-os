...
- **베이직쎈 공통수학1(스캔) 1570문항 LaTeX 조판 완료**: 스캔 크롭 1520 → 전사 에이전트 35개가 실제 문항 1570 확정(OCR 이 놓친 76 추가 · 라벨 상자·간지·오번호 26 제외), TikZ·표 그림 80. 검수 20(1570/1570 · **내용 불일치 0** · 🔴 1 = 원문 오식 의심 186-11 · 🟡 51 조판 규칙). 답지: 반 컬럼 격자·색 배지 보완으로 해설 1276→1454/1570, 등록 패키지의 답 이미지는 전사본 answer 조판(`--answers-from-bank`) 1570/1570. 상세 `latex-bank/ssen-basic-cm1/검수/2026-09-18/00-검수-요약.md`.
- **사람 Gate**: 바탕화면 `문제은행-패키지` 의 `rpm-공통수학1-라텍스-패키지`(문항 1184·해설 1184·답 1183)와 `베이직쎈-공통수학1-라텍스-패키지`(문항 1570·해설 1454·답 1570)를 교재관리 › 패키지 등록. 베이직쎈 186-11 원문 오식 여부는 실물 교재로 확인.
