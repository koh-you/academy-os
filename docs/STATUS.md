...
- 직전 등원 수업에 다음 숙제가 비어 있으면 더 오래된 정규수업 숙제로 건너뛰지 않는다. 이진후의 2026-08-31 수업에 2026-08-24 숙제가 연결된 운영 오데이터는 배포 후 CAS 삭제·재조회 대상으로 남겼다.
- lesson domain 22/22, runtime lint, 화·목·토가 서로 다른 시간인 회귀 fixture, focused safe browser, production build·chunk budget이 통과했다.
