...
1. App 2차 Phase 1~5와 3차 3-0~3-8은 완료됐다. 운영 저장 신뢰성의 시험정보·Tally 후보·개별 학생·반 명단·수동/파생 학사일정, 수업 복사·취소·되돌리기, 수업기록·숙제 다중 행 단위도 완료했다. 다음은 수업일지 등원보충 초안의 고정 요청 identity·결과 불명 재시도와 보충·알림 다중 원천 reconcile을 별도 단위로 점검한다.
