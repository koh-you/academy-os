...
3. App/API 4차는 4-0 기준선과 4-1a~4-1r의 source·notification reserve/cancel/reconcile/bulk/readiness payload contract 연결을 확정했다. 다음은 인증된 dispatch와 남은 provider write payload를 한 route씩 고정한다.
