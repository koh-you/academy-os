...
1. App 2차 Phase 1~5와 3차 3-0~3-8은 완료됐다. 운영 저장 신뢰성의 시험정보·Tally 후보·개별 학생·반 명단·수동/파생 학사일정과 수업 복사·취소·되돌리기 단위도 완료했다. 다음은 수업일지 `lesson_student_records`·숙제 다중 행 저장을 행별 CAS·재조회·부분성공 복구 계약으로 닫는다.
