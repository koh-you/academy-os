...
assert.equal(sharedStateKeys.includes("lessonResearchItems"), false);
...
console.log("app_state autosave concurrency inventory passed (9 keys; serialization/CAS/requery guarded)");
