...
assert.equal(directRouteMatches.length, 83);
...
const routeOrderHash = crypto
  ...
  .digest("hex");
assert.equal(routeOrderHash, "6d88fab62a965a77717275b6562c21eb5ec9779b5e1ba779e96129b3208e57a4");
