...
assert.equal(directRouteMatches.length, 100);
...
assert.equal(
  packageJson.scripts["test:fourth-pass-server-route-baseline"],
  "node scripts/test-fourth-pass-server-route-baseline.mjs && node scripts/test-integration-status-route-registry.mjs"
);
