...
assert.equal(directRouteMatches.length, 27);
...
const routeOrderHash = crypto
  ...
  .digest("hex");
assert.equal(routeOrderHash, "be5c8b6d7ebe78163718f32910fe94c9d791fe66abf8f98ddea0c43290406070");
