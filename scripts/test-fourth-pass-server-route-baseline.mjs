...
assert.equal(directRouteMatches.length, 25);
...
const routeOrderHash = crypto
  ...
  .digest("hex");
assert.equal(routeOrderHash, "030086b6e1d263410ed6bcb5b7cc19ec346e4f53b99a521068c5e5bb0c39e96d");
