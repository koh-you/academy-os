...
assert.equal(directRouteMatches.length, 81);
...
const routeOrderHash = crypto
  ...
  .digest("hex");
assert.equal(routeOrderHash, "a10b7515fa9430d1eb02c314243bf0d15da4f2c0c86578420969ee96b8b4cc54");
