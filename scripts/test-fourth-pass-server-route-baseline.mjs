...
assert.equal(directRouteMatches.length, 68);
...
const routeOrderHash = crypto
  ...
  .digest("hex");
assert.equal(routeOrderHash, "91cba2429093335d52a7cfc8b80cacfb2bc6ae7bfe75ba8626815ad0f5da0378");
