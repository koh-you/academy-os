...
results.push(assert("19. PageSnap/material import path remains present", includesAll(app, ["createProblemBooksFromPageSnapJson", "createSsenCommonMath1PageSnapExample", "sourceType: \"pagesnap\"", "source_file_name"])));
