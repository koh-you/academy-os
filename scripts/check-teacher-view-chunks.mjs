...
assert.ok(
  mainBytes <= 1_250_000,
  `initial main JavaScript exceeded the 1.25 MB 3-7 budget: ${mainBytes.toLocaleString()} bytes`
);
...
console.log(
  `teacher view chunk budget passed · main ${(mainBytes / 1000).toFixed(2)} kB · lazy ${expectedLazyChunks.length}/6`
);
