...
export const domainTestGroups = Object.freeze({
  lesson: Object.freeze([
    ...
    "scripts/test-school-event-persistence.mjs",
    "scripts/test-derived-school-calendar-persistence.mjs",
    ...
    "scripts/test-resource-material-persistence.mjs",
    "scripts/test-resource-material-storage.mjs",
    "scripts/test-report-snapshot-persistence.mjs",
    "scripts/test-lesson-journal-draft-controller.mjs",
    "scripts/test-lesson-journal-effect-adapter.mjs",
    "scripts/test-lesson-homework-continuity.mjs",
    "scripts/test-lesson-nested-panels-boundary.mjs",
    "scripts/test-attendance-kiosk-auto-confirm.mjs",
  ...
  student: Object.freeze([
    ...
    "scripts/test-student-persistence.mjs",
    "scripts/test-class-roster-persistence.mjs",
  ...
  notification: Object.freeze([
    ...
    "scripts/test-notification-message-renderer.mjs",
    "scripts/test-notification-template-transport-contract.mjs",
    "scripts/test-notification-template-closeout.mjs",
    ...
    "scripts/test-notification-job-source-contract.mjs",
    "scripts/test-notification-job-reserve-contract.mjs",
    "scripts/test-notification-job-cancel-contract.mjs",
