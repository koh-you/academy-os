...
check("41c assignment status copy follows latest parent and student tone", hasAll(app, ["남은 부분은 다음 시간에 함께 확인하도록 하겠습니다.", "필요하면 추가 등원보충으로 관리하겠습니다.", "쉬운 문항 위주로 풀어온 것으로 보입니다.", "과제 난이도를 조정해보도록 하겠습니다.", "남은 부분은 다음 시간에 같이 확인하자.", "필요하면 추가 등원보충으로 마무리하자.", "쉬운 문항 위주로 풀어온 것 같아."]) && hasAll(notificationRoute, ["남은 부분은 다음 시간에 함께 확인하도록 하겠습니다.", "필요하면 추가 등원보충으로 관리하겠습니다.", "남은 부분은 다음 시간에 같이 확인하자.", "필요하면 추가 등원보충으로 마무리하자."]));
