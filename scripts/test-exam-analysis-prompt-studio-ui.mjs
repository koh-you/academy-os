...
assert(component.includes("className=\"examPromptRoleCard\" defaultOpen"));
...
assert(css.includes(".examPromptSaveBadge .inlineSaveStatus"));
assert(css.includes('.examPromptRoleToggles input[type="checkbox"]'));
assert(css.includes("height: 17px"));
assert(css.includes(".examPromptRoleCard > .disclosureTrigger"));
